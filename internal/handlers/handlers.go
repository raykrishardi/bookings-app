...
func (m *Repository) PostReservation(w http.ResponseWriter, r *http.Request) {
	...
	Dear %s, <br>
	This is to confirm your confirmation from %s to %s
	...
	This is to confirm that there is a reservation from %s to %s
	`, reservation.StartDate.Format("2006-01-02"), reservation.EndDate.Format("2006-01-02"))

	msg = models.MailData{
		From:     "me@hello.com",
		To:       "property@admin.com",
		Subject:  "Reservation Confirmation",
		Content:  htmlMessage,
		Template: "basic.html",
	}
...
func (m *Repository) PostAvailability(w http.ResponseWriter, r *http.Request) {
	...
	// 2022-01-01 (YYYY-MM-DD) convert to golang datetime 01/02 03:04:05PM '06 -0700
...
func (m *Repository) PostShowLogin(w http.ResponseWriter, r *http.Request) {
	...
	form.IsEmail("email")
	if !form.Valid() {
		// Take user back to the login page if the fields are not valid
		render.Template(w, r, "login.page.tmpl", &models.TemplateData{
			Form: form,
		})
		return
...
func (m *Repository) AdminShowReservation(w http.ResponseWriter, r *http.Request) {
	// Get the reservation ID from route param
	...
	// Get the source (new/all) from route param
